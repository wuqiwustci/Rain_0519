...
radarData_url_folder="D:\\program_0519rain\\data\\CMPAS降水实况下载链接"
#html文件中下载链接在第几列，是第几列就是几，后续自定义函数代码中已包含减1
url_rowNumber=4
#提取出来的下载链接txt文件名
url_filename='SURF_CMPAS_MUL_1KM_RT.txt'
#下载链接那列的表头所含字符串，用来去除表头只保留下载链接
thead_string='路径'
#数据下载后储存文件夹
rada_data_download_folder='D:\\program_0519rain\\data\\CMPAS降水实况'
...
# python D:\program_0519rain\download_by_choromedriver_rain.py
